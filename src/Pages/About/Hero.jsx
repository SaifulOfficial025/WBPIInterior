...
function Hero() {
  return (
    <div className="w-full bg-white text-gray-800 mt-20 sm:mt-20 mt-16">
      {/* Top: About Us section */}
      <div className="max-w-full mx-auto px-4 md:px-0 pt-8 pb-2 sm:pt-8 pt-4">
        <div className="text-3xl sm:text-3xl text-2xl font-semibold mb-6 mx-6 sm:mx-6 mx-4">
          ABOUT US
        </div>
        <div className="flex flex-col md:flex-row gap-24 sm:gap-24 gap-8 mx-6 sm:mx-6 mx-4">
          {/* Left: Main text */}
          <div className="flex-1 min-w-0">
            <div className="text-gray-700 text-xl sm:text-xl text-base font-light mb-4 max-w-5xl">
            ...
            <div className="text-black text-xl sm:text-xl text-base font-bold mb-4 max-w-5xl">
            ...
            <div className="text-gray-700 text-xl sm:text-xl text-base font-light max-w-5xl">
          ...
          <div className="flex-1 min-w-0 flex md:justify-start ">
            <div className="bg-[#777472] text-white text-xl sm:text-xl text-base font-light p-16 sm:p-16 p-6 max-w-2xl w-full md:w-[640px] md:max-h-[400px] flex items-center">
      ...
      <div className="w-full mt-10 sm:mt-10 mt-6">
        <img
          src="/abouthero.png"
          alt="About Us Hero"
