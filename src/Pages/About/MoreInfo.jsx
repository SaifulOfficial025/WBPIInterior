...
function MoreInfo() {
  return (
    <div className="w-full bg-white text-gray-800 pt-4">
      ...
      <div className="text-2xl font-semibold tracking-wide px-4 md:px-0 mb-2 ml-6 mt-16">
        MORE INFORMATION
      </div>
      ...
      <div className="max-w-full mx-auto flex flex-col md:flex-row items-stretch gap-0">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center justify-center py-8">
          <img
            ...
            className="w-[320px] md:w-[340px] lg:w-[380px] h-auto"
          />
        ...
        {/* Right: Stats image */}
        <div className="w-full md:w-1/2 flex items-center justify-center bg-white py-8">
          <img
            src="/moreinfo1.png"
            alt="Company Stats"
            className="w-full max-w-[420px] md:max-w-[480px] h-auto object-cover"
          />
        </div>
      </div>
      ...
      <div className="w-full mt-2">
        <img
          src="/options.png"
          alt="Design Pattern"
          className="w-full object-cover max-h-16"
        />
      </div>
      {/* Bottom: Tagline */}

      <div className="max-w-full text-md font-light text-black mt-8 border-b border-gray-300  mb-16">
        <span className="ml-6">
