...
function ProvenRecord() {
  return (
    <div className="w-full bg-white text-gray-800  py-10">
      <div className="max-w-full mx-auto flex flex-col md:flex-row gap-10 md:gap-16 items-stretch">
        {/* Left: Image with stats overlay */}
        <div className="w-full md:w-1/2 flex items-stretch">
          <div className="relative w-full h-[320px] md:h-auto  overflow-hidden shadow-md">
            <img
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center">
          ...
          <div className="text-gray-700 text-base md:text-2xl font-light mb-4">
          ...
          <ul className="text-gray-700 text-2xl font-light list-disc list-inside mb-4 space-y-1">
          ...
          <div className="text-gray-600 text-base md:text-xl font-light">
