...
function Cad3d() {
  return (
    <div className="w-full bg-white text-gray-800 px-0 md:px-0 py-0">
      {/* Top bar */}
      <div className="pt-16 sm:pt-16 pt-8 w-full px-4 flex flex-col md:flex-row justify-between items-center text-xs text-gray-500 border-b border-gray-400 pt-2 pb-1 gap-2 ">
        <span className="font-semibold text-black text-md sm:text-md text-sm text-left md:text-base w-full md:w-auto ">
      ...
      {/* Main content */}
      <div className="max-w-full mx-16 sm:mx-16 mx-4 flex flex-col md:flex-row py-8 sm:py-8 py-4">
        {/* Left: Text content */}
        <div className="w-full flex flex-col gap-6 sm:gap-6 gap-4">
          <div>
            <div className="text-2xl sm:text-2xl text-xl font-normal mb-2">
              CAD &amp; 3D
            </div>
            <div className="text-gray-500 text-xl sm:text-xl text-base font-light mb-4 sm:mb-4 mb-2 max-w-full">
          ...
          {/* Gray info box */}
          <div className="bg-[#767374] text-gray-100 text-xl sm:text-xl text-base font-light p-8 sm:p-8 p-4 max-w-lg mb-2 mx-auto">
          ...
          {/* Key Benefits */}
          <div>
            <div className="text-2xl sm:text-2xl text-xl font-semibold mb-2">
              KEY BENEFITS
            </div>
            <ul className="text-gray-700 text-xl sm:text-xl text-base list-disc list-inside space-y-1">
        ...
        {/* Right: Image */}
        <div className="w-full md:w-1/2 flex justify-center items-start mt-6 sm:mt-6 mt-4 md:mt-0">
          <img
            src="/cad3d.png"
            alt="CAD and 3D Visualisation"
            className="object-contain w-full max-w-[540px] h-auto border-8 sm:border-8 border-4 border-[#767374] bg-white"
          />
        </div>
      </div>
    </div>
